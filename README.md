...
## Материалы для корректировки КР

В [docs/coursework-corrections.md](docs/coursework-corrections.md) собраны готовые формулировки по конфигурации, хранению паролей, архитектуре доступа к БД и тестовому покрытию. Утверждения снабжены внутритекстовыми ссылками `[1]–[7]` и списком первичных электронных источников.
